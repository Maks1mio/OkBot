...
var botConfigs = {
    ...
    {
        "id": 4,
        "name": "!report @user spam - Report user",
        "activated": true,
        "config": "",
        "info": {
    ...
    {
        "id": 5,
        "name": "!tempmute @user 10s - Temp mute user",
        "activated": true,
        "config": "",
        "info": {
    ...
    {
        "id": 7,
        "name": "!weather Copenhagen - Weather info",
        "activated": true,
        "config": "weather",
        "info": {
    ...
    {
        "id": 8,
        "name": "!play {YouTube URL}, !leave, !pause, !resume, !queue, !skip - Music YouTube",
        "activated": true,
        "config": "",
        "info": {
    ...
    {
        "id": 13,
        "name": "!dm <@user or ID> Message - DM message",
        "activated": true,
        "config": "",
        "info": {
...
client.on("message", async function (message) {
    ...
    if (command === "serverinfo" && botConfigs.plugins[6].activated == true) {
        ...
        let sererembed = new Discord.RichEmbed()
            ...
            //.setFooter("footer text", "https://cdn.discordapp.com/attachments/482180995752394752/658194272323108885/lup.gif")
            //.setThumbnail("https://cdn.discordapp.com/attachments/482180995752394752/658194272323108885/lup.gif")
           // .setImage("https://cdn.discordapp.com/embed/avatars/0.png")
            .setAuthor("Hyxl", "https://cdn.discordapp.com/app-icons/666151106958852116/592cc429fa5b3c022b546aa18649e63a.png", "https://discordapp.com/invite/HwnpTWS")
          //  .addField("🤔", "https://discord.gg/HwnpTWS", false)


        return message.channel.send(sererembed);
    }

    if (command === "rules" && botConfigs.plugins[7].activated == true) {
        let sicon = message.guild.iconURL;
        let sererembed = new Discord.RichEmbed()
            .setDescription("Server Information")
            .setColor("#15f153")
    ...
    if (command === "ticket" && botConfigs.plugins[12].activated == true) {
        ...
        if (command === "dm" && botConfigs.plugins[13].activated == true) {
            ...
            let dmEmbed = new Discord.RichEmbed()
                ...
                .setFooter("This message was sent to you by: " + `${message.author.username}  ` + " in " + `${timestamp('hh:mm:ss')}`, `${message.author.displayAvatarURL}`)
